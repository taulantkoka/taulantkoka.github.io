...
<p><strong>Hosting über GitHub Pages</strong></p>
<p>Diese Webseite wird als statische Seite über GitHub Pages (GitHub Inc., 88 Colin P. Kelly Jr St, San Francisco, CA 94107, USA) gehostet. Beim Zugriff auf diese Seite werden von GitHub Log-Files erstellt, die u.a. IP-Adressen speichern. Dies erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der technischen Bereitstellung und Sicherheit). Weitere Informationen finden Sie in der <a href="https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement" target="_blank">Datenschutzerklärung von GitHub</a>.</p>
...
Daten werden nur solange gespeichert wie dies für den genannten Zweck erforderlich ist. Hierbei werden steuer- und handelsrechtliche Aufbewahrungsfristen berücksichtigt.</p>

<p>Wir weisen ausdrücklich darauf hin, dass die Datenübertragung im Internet (z. B. bei der Kommunikation per 
E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist nicht möglich.</p>
...
<p>&nbsp;</p>
<p><small>Dieses Impressum wurde mit Hilfe des Impressum-Generators von <a target="_blank" 
href="http://www.hensche.de/impressum-generator.html">HENSCHE Rechtsanwälte</a> erstellt.</small></p>