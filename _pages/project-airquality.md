...
![Station trend]<a href="{{ '/figures_airquality/darmstadt_NO2_station_trend.svg' | relative_url }}" class="image-popup"> <img src="{{ '/figures_airquality/darmstadt_NO2_station_trend.svg' | relative_url }}" alt="Station trend">
</a>
