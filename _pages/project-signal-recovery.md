...
<p class="h3-ghost">Recovering Multi-Channel Signals with Unknown Sample-Channel Assignments</p>
...
<p class="h3-ghost">The Core Idea</p>
...
This is not a noise problem. The measurements themselves are fine. The problem is that the label assignments are wrong, and you don't know which ones.
...
<a href="/figures_ccus/shuffled_signals.svg" class="image-popup" title="Shuffled Signals">
  <img src="/figures_ccus/shuffled_signals.svg" alt="Shuffled Signals"
    style="background: #fff; border-radius: 6px; padding: 1em; width: 100%; min-height: 200px; display: block;cursor: zoom-in;">
</a>
